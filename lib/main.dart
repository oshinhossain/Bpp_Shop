...
import 'package:bpp_shop/view/grocery/core/controller/product_detail_data_controller.dart';
...
import 'package:bpp_shop/view_model/grocery/grocery_drawer_view_model.dart';
    ...
    return MultiProvider(
      providers: [
        ChangeNotifierProvider<BannerProvider>(
            create: (BuildContext) => BannerProvider()),
        ChangeNotifierProvider<BrandProvider>(
            create: (BuildContext) => BrandProvider()),
        ChangeNotifierProvider<HotDealsProvider>(
            create: (BuildContext) => HotDealsProvider()),
        ...
        ChangeNotifierProvider.value(
            value: GroceryDrawerViewModel()), //CustomScafoldKey
      ...
      child: ScreenUtilInit(
        ...
        builder: (BuildContext context, Widget? child) {
          ...
          drawerProvider.loadDrawerData();
          final gdrawerProvider = Provider.of<GroceryDrawerViewModel>(context);
          gdrawerProvider.loadGDrawerData();
          final orderProceedViewModel =
              Provider.of<OrderProceedViewModel>(context);
