...
import 'package:bpp_shop/view/bpp/floatingButton.dart';
...
class SubSubCategoryWiseProductView extends StatefulWidget {
  SubSubCategoryWiseProductView(
      {Key? key,
        this.title,
        required this.categoryId,
        required this.subCategoryId,this.nameFromFacebook, this.routeKey})
      : super(key: key);
  String? title;
  ...
  @override
  _SubSubCategoryWiseProductViewState createState() =>
      _SubSubCategoryWiseProductViewState();
}

class _SubSubCategoryWiseProductViewState
    extends State<SubSubCategoryWiseProductView> {
