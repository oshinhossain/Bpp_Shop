      ...
      itemBuilder: (context, index) {
        return Container(
          ...
          decoration: BoxDecoration(
              ...
              //     isSelectAddress
              //     ?
              color:orderProceedViewModel.addressList[index].status=="1"?Color(0xffECF9EB):Colors.white,
              //    : Colors.white,
          ...
          child: Row(
            ...
            children: [
              ...
              Container(
                ...
                child: Center(
                  child: TextButton(
                    onPressed: orderProceedViewModel.addressList[index].status=="1"? () {
                      print("Change>>>>>>>>>>>>>>>>>>>>>>>>>");
                    ...
                    child: Text(
                      orderProceedViewModel.addressList[index].status=="1"?"Change":'Delete',
                      style: TextStyle(
