...
import 'dart:convert';
import 'package:bpp_shop/fashion/widget/sub_sub_catagory.dart';
import 'package:flutter/material.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart'as http;
class sub_Categories extends StatefulWidget {
  const sub_Categories({Key? key}) : super(key: key);
  @override
  _sub_CategoriesState createState() => _sub_CategoriesState();
}
            ...
            return  GridView.builder(
              ...
              itemBuilder: (BuildContext context,int index){
                return GestureDetector(
                  onTap: (){
                    Navigator.of(context).push(MaterialPageRoute(builder:(context)=>sub_sub_Categories()));
