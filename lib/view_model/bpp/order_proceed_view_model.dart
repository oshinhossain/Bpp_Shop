...
import '../../view/bpp/address/widget_add_address_button.dart';
import '../../view/bpp/address/widget_address_list_view.dart';
import '../../view/bpp/address/widget_selected_address.dart';
...
class OrderProceedViewModel with ChangeNotifier{
  ...
  void getSelectAddress(){
    List<AddressModel> statusList = addressList.where((element) => element.status=="1").toList();
